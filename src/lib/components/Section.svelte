...
<div class="min-w-80 pt-4.5 pr-4.5 {className}" in:fade>
	<div class="relative rounded-2xl border-3 border-black p-4 dark:border-white">
		...
		{#if icon}
			<div
				class="absolute bottom-full left-full -translate-x-2/3 translate-y-2/3 rounded-full border-3 border-black bg-white px-3 py-3 dark:border-white dark:bg-gray-800 dark:text-white"
			>
				{@render icon()}
			</div>
		{/if}
